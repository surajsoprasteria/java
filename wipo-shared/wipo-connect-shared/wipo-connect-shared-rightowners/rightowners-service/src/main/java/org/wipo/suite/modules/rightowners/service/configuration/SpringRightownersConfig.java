 ...
 */
@Configuration
public class SpringRightownersConfig extends WebMvcConfigurationSupport {

    protected static final Logger LOGGER = LoggerFactory.getLogger(SpringRightownersConfig.class);

    private static final String cacheName = "wcc-rightowners";
