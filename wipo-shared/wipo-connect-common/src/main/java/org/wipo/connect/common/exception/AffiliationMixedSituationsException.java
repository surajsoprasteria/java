...
public class AffiliationMixedSituationsException extends WccException {

	private static final long serialVersionUID = 6369687185206281533L;


    @JsonCreator
    protected AffiliationMixedSituationsException(
     ...
     */
    public AffiliationMixedSituationsException(String message) {
